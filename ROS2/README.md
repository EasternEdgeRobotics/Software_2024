...
```
docker run -v "<PATH TO ROS2 directory on your computer>":/home/ROS2  -p 9090:9090 --mount source=colcon_ws,destination=/home/colcon_ws -it osrf/ros:humble-desktop
```
