...
import { CameraIPs, CurrentController } from "../components/Atoms";
  ...
  return (
    <Grid container spacing={2}>
        ...
        <Paper elevation={7} sx={{ borderRadius: "12px" }}>
          ...
          <h3 style={{ margin: "0", textAlign: "center" }}>
            {currentController === -1
              ...
              : `Current Controller: ${
                  navigator.getGamepads()[currentController]!.id
                }`}
          </h3>
        </Paper>
      </Grid>
      ...
      >
        <Paper
          elevation={7}
          sx={{ alignSelf: "flex-start", borderRadius: "12px", width: "100%" }}
        >
        ...
        <Paper
          elevation={7}
          sx={{ alignSelf: "flex-end", borderRadius: "12px", width: "100%" }}
        >
